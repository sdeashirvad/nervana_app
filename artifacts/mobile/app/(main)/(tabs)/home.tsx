...
const flowStyles = StyleSheet.create({
  ...
  track: { flex: 1, height: 4, backgroundColor: "rgba(255,255,255,0.07)", borderRadius: 2, overflow: "hidden" },
      ...
      >
        ...
        <Animated.View entering={FadeInUp.delay(160).duration(700)} style={insightStyle}>
          <PremiumCard style={styles.insightCard}>
            ...
            <Text style={[styles.sectionEyebrow, { color: colors.mutedForeground, marginBottom: 10 }]}>
              Today's insight
            </Text>
        ...
        <ActionCard
          ...
          accent="#E8B86D"
          onPress={() => router.navigate("/(main)/(tabs)/journal")}
          delay={420}
        />
